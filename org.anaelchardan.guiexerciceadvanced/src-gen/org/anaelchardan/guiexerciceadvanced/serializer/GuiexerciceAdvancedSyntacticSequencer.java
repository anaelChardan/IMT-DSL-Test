...
public class GuiexerciceAdvancedSyntacticSequencer extends AbstractSyntacticSequencer {

	protected GuiexerciceAdvancedGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (GuiexerciceAdvancedGrammarAccess) access;
	 ...
	 *     frameName=FrameName '{' (ambiguity) 'height' ':' height=INT
	 *     frameName=FrameName '{' (ambiguity) 'title' ':' title=STRING
	 *     frameName=FrameName '{' (ambiguity) 'width' ':' width=INT
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     frameName=FrameName '{' (ambiguity) '}' (rule end)
	 */
	 ...
	 *     frameName=FrameName '{' 'content' '{' (ambiguity) contents+=Content
